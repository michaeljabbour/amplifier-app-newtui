...
(:func:`amplifier_app_tui.model.config.parse_config_command`) and drives
the runtime adapter's config surface, posting an
:class:`~amplifier_app_tui.model.blocks.Answer` (or a transient notice)
per subcommand. It mirrors :mod:`amplifier_app_tui.ui.directory_admin`:
