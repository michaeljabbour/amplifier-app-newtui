...
:class:`~amplifier_app_tui.model.blocks.Answer` to the transcript; these
pure functions turn the frozen
:class:`~amplifier_app_tui.model.config.ConfigSnapshotView` into the flat
``Segment`` stream that block carries, matching the house style of
:mod:`amplifier_app_tui.ui.session_ops_view` (blue ``\u00b7`` marker,
