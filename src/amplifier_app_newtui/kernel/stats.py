...
the live cost footer (:class:`~amplifier_app_newtui.kernel.cost.CostTracker`) records — priced
through :func:`~amplifier_app_newtui.kernel.cost.cost_of` (a provider-reported ``cost_usd`` wins,
